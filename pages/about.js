    ...
    return ( 
        <div className = {styles.disclaimer}>
            <h1 className="mb-4 text-4xl lg:text-6xl leading-tight">About</h1>
                <br />
            <p className="mb-4 mr-6 text-3xl lg:text-3xl leading-tight">My name is Teo.</p>   
            <br /><p className="mb-4 mr-6 text-2xl lg:text-2xl leading-tight">I am an American expat living in Japan with my lovely wife.   I am a trader, specializing in options and equities on daily timeframes.   I am also  programmer and technical analysis nerd.  </p>
