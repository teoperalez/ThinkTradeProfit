...
const About = () => {
    ...
    return ( 
        <div className = {styles.disclaimer}>
            ...
            <p className="mb-4 mr-6 text-2xl lg:text-2xl leading-tight">I am an American expat living in Japan with my lovely wife.   I am a trader, specializing in options and equities on daily timeframes.   I am also  programmer and technical analysis nerd.  </p>
